exports.HELP_MESSAGE = [ '/help - show this page',
    ...
    '/status - current status of waivio services' ].join('\n');
...
exports.APILINKS_MESSAGE = [ 'WAIVIO Docs links:',
    ...
    ' - https://app.swaggerhub.com/apis/waivio/investarena-api/1.0.0',
    ' - https://app.swaggerhub.com/apis/waivio/objects-bot/1.0.0' ].join('\n');
